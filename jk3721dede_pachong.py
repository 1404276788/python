...
url_txt='C:/Users/Administrator/Desktop/url_txt.txt'  #路径
...
url_arr_txt='C:/Users/Administrator/Desktop/url_arr_txt.txt'  #路径
for urllist in url_txt_arr:
    r=gethtml(urllist)
    lista=get_text_link_from_sel(sel_link)
    print(lista)
